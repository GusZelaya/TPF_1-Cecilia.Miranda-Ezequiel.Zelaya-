...
void tablerosPuntaje(int colorMaquina) {
    ...
    int TPuntajeMaquinaColor0[16][16] = {
    ...
    int TPuntajeMaquinaColor1[16][16] = {
    ...
    switch (colorMaquina) {
        ...
        case 0:
            ...
            for (int i = 0; i < 16; i++) {
                for (int j = 0; j < 16; j++) {
                	TPuntajeUsuario[i][j] = TPuntajeMaquinaColor0[i][j];
                    TPuntajeMaquina[i][j] = TPuntajeMaquinaColor1[i][j];
                }
            }
            break;
